...
const CurrentLecture = ({onclick,label}:CurrentLectureProps) => {
  ...
  return (
    ...
    <section className='flex w-fit overflow-x-scroll items-center scr'>
...
<button onClick={onclick} className='box-border  rounded-full bg-green-500 text-white font-bold'>{label}</button>
