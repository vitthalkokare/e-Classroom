...
const UserValidate = () => {
  ...
  return (
    <>
      {isuser ? (
        <div className="w-[60%] sm:w-[90%] sm:left-[5%]  min-h-[80vh] sm:min-h-[400px] fixed  top-5  left-[20%] flex justify-center  rounded-xl sm:flex-col z-50 box-border   bg-white text-black">
          ...
          <button
            ...
            className="absolute right-0 top-0 box-border text-white bg-black p-2 rounded-full py-1 "
          >
            X
          </button>
        </div>
