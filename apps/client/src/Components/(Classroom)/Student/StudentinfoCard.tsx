...
const StudentinfoCard = () => {
  ...
  return (
    <div className="sm:w-[70%] shadow-gray-700 shadow-2xl z-50  w-[90%] min-h[500px] max-h-fit bg-yellow-200 absolute  mx-auto top-10 left-[5%] sm:left-[15%]  box-border p-4 rounded-xl">
